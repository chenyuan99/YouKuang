...
export const ACCOUNT_TO_CONTENT: { [key: string]: AccountItem[] } = {
    0: [
        ...
        new AccountItem(2, '支出', 2123, '吃', new Date(Date.now()), '又要长胖了 嘤'),
        new AccountItem(3, '收入', 20002, '工资', new Date(Date.now()), '打工是不可能打工的.....真香!!'),
    ],
    1: [
        new AccountItem(0, '支出', 2000, '吃', new Date(Date.now()), '又要长胖了 嘤111'),
        new AccountItem(1, '收入', 2000, '工资', new Date(Date.now()), '打工是不可能打工的.....真香!!111'),
        new AccountItem(2, '支出', 2000, '吃', new Date(Date.now()), '又要长胖了 嘤'),
        new AccountItem(3, '收入', 2000, '工资', new Date(Date.now()), '打工是不可能打工的.....真香!!'),
        new AccountItem(4, '支出', 2123, '吃', new Date(Date.now()), '又要长胖了 嘤'),
        new AccountItem(5, '收入', 20002, '工资1', new Date(Date.now()), '打工是不可能打工的.....真香!!'),
        new AccountItem(6, '收入', 20002, '工资2', new Date(Date.now()), '打工是不可能打工的.....真香!!'),
        new AccountItem(7, '收入', 20002, '工资3', new Date(Date.now()), '打工是不可能打工的.....真香!!'),
        new AccountItem(8, '收入', 20002, '工资4', new Date(Date.now()), '打工是不可能打工的.....真香!!'),
        new AccountItem(9, '收入', 20002, '工资5', new Date(Date.now()), '打工是不可能打工的.....真香!!'),
        new AccountItem(10, '收入', 20002, '工资6', new Date(Date.now()), '打工是不可能打工的.....真香!!'),
    ],
    2: [
        new AccountItem(0, '支出', 2000, '吃', new Date(Date.now()), '又要长胖了 嘤'),
        new AccountItem(1, '收入', 2000, '工资', new Date(Date.now()), '打工是不可能打工的.....真香!!'),
